...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    const embed3 = createEmbed([
      { name: `__Module Information__`, value: `**Discord Api Wrapper**: v14.14.1 ([discord.js](https://discord.js.org/))\n**NodeJs Version**: v20.10.0\n**Database**: v9.1.7 (Better-Sqlite3)\n**Platform**: linux\n**Archtitecture**: x64` }
    ]);
    ...
    const embed4 = createEmbed([
      ...
      { name: `__Organization__`, value: `- <a:GLC_heart:1209166748947980338> Fusion Discronix\n- [Discord Server Link](https://dsc.gg/discronix)`}
    ]);
