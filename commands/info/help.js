...
module.exports = {
  ...
  run: async function (client, message, args) {
    ...
    const embed1 = new MessageEmbed()
      ...
      .setDescription(
        `Hey It's Me Lock N Loaded a  Multipurpose Bot With All The Features And Commands You Need With Over Powered Features Come Manage Your Server With Me\n\n<:Discronix_StarDia:1280803322860929057> __**Links**__\n> **[Support](https://dsc.gg/discronix)**\n> **[Invite Me](https://dsc.gg/discronix)**`,
      )
      .addField(
        "<:Discronix_DoubleArrowRight:1280803180887801856> __Commands__",
